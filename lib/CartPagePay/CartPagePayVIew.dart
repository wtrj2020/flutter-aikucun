...
import 'CartPagePayProvider.dart';

class CartPagePayView extends StatelessWidget {
  const CartPagePayView({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CartPagePayProvider>(
        create: (context) => CartPagePayProvider.instance(),
        child: Consumer<CartPagePayProvider>(
                    ...
                    return Scaffold(
                      ...
                      body: ListView(
                        children: <Widget>[
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Center(child: Text('${viewModel.data.data.orderunique}', style: TextStyle(color: Colors.black87))),
                                ],
                              ),
                            ),
                          ),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Center(child: Text('¥${viewModel.data.data.goodsMoney}', style: TextStyle(color: Colors.red))),
                                ],
                              ),
                            ),
                          ),
                          ...
                          //  ...viewModel.data.data.payments.map((payments) => paylist(payments)),
                          paylist(viewModel.data.data.payments)
                        ],
                      ),
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                child: Row(
                                  children: <Widget>[
                                    Text('合计:'),
                                    Text('¥${viewModel.data.data.goodsMoney}', style: TextStyle(color: Colors.pink)),
                                    SizedBox(width: 5),
                                    Container(
                                      color: Colors.red,
                                      child: GestureDetector(
                                        ...
                                        onTap: () async {
                                          ...
                                          //////
                                          var formData = {
                                            "order_no": viewModel.data.data.orderunique,
                                            "pay_from": payFrom,
                                          };
  ...
  Widget paylist(payments) {
    return ChangeNotifierProvider<CartPagePayChangeProvider>(
        create: (context) => CartPagePayChangeProvider.instance(),
        child: Consumer<CartPagePayChangeProvider>(
          builder: (context, viewModel, child) {
            return Column(
              children: <Widget>[
