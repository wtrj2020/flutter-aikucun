...
class MemberOrderPayProvider with ChangeNotifier {
  ConfirmOrderClass data;
  int groupValueb;
String payFrom;
  MemberOrderPayProvider.instance() {
    //
  }

  MemberOrderPayProvider.eee(int valueb,String payFrom) {
...
class MemberOrderPayChangeProvider with ChangeNotifier {
  ConfirmOrderClass data;
  int groupValueb;

  MemberOrderPayChangeProvider.instance() {
    //
  }


  void changeValue(value,payFrom) async {
    MemberOrderPayProvider.eee(groupValueb,payFrom);
    groupValueb = value;
   // await editRequest(value, 0);
